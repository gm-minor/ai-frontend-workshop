...
function AddToCartButton({ productId, productName, inStock, className = '' }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: `w-full py-8 px-6 rounded-xl font-semibold transition-all duration-300 transform hover:scale-[1.02] shadow-lg ${inStock ? 'focus:ring-2 focus:ring-red-400 focus:ring-offset-2' : 'cursor-not-allowed'} ${className}`,
        style: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8707bd8b._.js.map